import{j as o}from"./jsx-runtime-B1AhRb-V.js";import{r as u}from"./index-CV65Cz2T.js";import{e as m}from"./routes-Doxg9Phi.js";import{L as y}from"./Link-BYFNg5bx.js";import{u as f}from"./useRouteRef-DZfF4Gng.js";import{E as g}from"./EntityDisplayName-BAmCLWZ8.js";import{p as b,D as w}from"./ref-8pKZtiZi.js";const v=u.forwardRef((e,r)=>{const{entityRef:t,defaultKind:n,defaultNamespace:i,title:s,children:a,hideIcon:l,disableTooltip:d,...h}=e,p=k(e.entityRef),c=a??s??o.jsx(g,{entityRef:t,defaultKind:n,defaultNamespace:i,hideIcon:l,disableTooltip:d});return o.jsx(y,{...h,ref:r,to:p,children:c})});function k(e){const r=f(m);let t,n,i;if(typeof e=="string"){const a=b(e);t=a.kind,n=a.namespace,i=a.name}else"metadata"in e?(t=e.kind,n=e.metadata.namespace,i=e.metadata.name):(t=e.kind,n=e.namespace,i=e.name);t=t.toLocaleLowerCase("en-US"),n=(n==null?void 0:n.toLocaleLowerCase("en-US"))??w;const s={kind:encodeURIComponent(t),namespace:encodeURIComponent(n),name:encodeURIComponent(i)};return r(s)}v.__docgenInfo={description:`Shows a clickable link to an entity.
...
various ways.`},{key:"links",value:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  ...
  namespace: string;
  name: string;
}`,signature:{properties:[{key:"kind",value:{name:"string",required:!0}},{key:"namespace",value:{name:"string",required:!0}},{key:"name",value:{name:"string",required:!0}}]}},{name:"string"}]},description:""},defaultKind:{required:!1,tsType:{name:"string"},description:""},defaultNamespace:{required:!1,tsType:{name:"string"},description:""},title:{required:!1,tsType:{name:"string"},description:"@deprecated This option should no longer be used; presentation is requested through the {@link entityPresentationApiRef} instead"},children:{required:!1,tsType:{name:"ReactNode"},description:""},hideIcon:{required:!1,tsType:{name:"boolean"},description:""},disableTooltip:{required:!1,tsType:{name:"boolean"},description:""}}};export{v as E};
